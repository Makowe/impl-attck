\begin{tikzpicture}
	...
	\node[align=left, anchor=west] at (9, 1.625) {$x_{i+1}$};
	\draw[pattern=crosshatch] (6,1.5) rectangle (8,1.75);	
	\draw (0,1.5) rectangle (8,1.75);	
	
	\node[align=left, anchor=west] at (9, 1.125) {$x_{i+1} <<< 1$};
	\draw[pattern=crosshatch] (5.75,1) rectangle (7.75,1.25);
	\draw (0,1) rectangle (8,1.25);	
	
	\node[align=left, anchor=west] at (9, 0.625) {$x_{i+1} <<< 8$};
	\draw[pattern=crosshatch] (4,0.5) rectangle (6,0.75);
